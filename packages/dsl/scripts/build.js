...
tsc({ module: 'amd',      target: 'es2015', lib: 'esnext,dom', forof: true });
tsc({ module: 'commonjs', target: 'es2015', lib: 'esnext,dom', forof: true });

shell.mkdir('-p', 'dist/commonjs/node_modules/@validations');
shell.ln('-s', '../../src', 'dist/commonjs/node_modules/@validations/dsl');
